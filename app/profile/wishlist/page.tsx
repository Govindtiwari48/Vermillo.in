    ...
    if (wishlist.length === 0) {
        return (
            <div className="min-h-screen bg-gradient-light pb-16">
                <div className="container mx-auto px-6 max-w-6xl pt-6 md:pt-8">
                    <motion.div
                    ...
                    >
                        ...
                        <div className="text-3xl serif font-semibold text-gray-900 mb-4">
            ...
            <div className="container mx-auto px-6 max-w-6xl pt-6 md:pt-8">
                ...
                >
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <div className="text-4xl serif font-semibold text-gray-900 mb-2">
                                My Wishlist
                            </div>
